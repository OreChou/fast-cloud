...
import org.orechou.fast.gateway.fallback.FastGatewayBlockFallbackProvider;
...
@Slf4j
@Configuration
public class FastGatewaySentinelFilter {
    ...
    @PostConstruct
    public void doInit() {
        ZuulBlockFallbackManager.registerProvider(new FastGatewayBlockFallbackProvider());
        initGatewayRules();
    }
