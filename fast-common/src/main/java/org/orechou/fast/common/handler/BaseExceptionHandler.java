...
public class BaseExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public FastResponse handleFastException(FastException e) {
        log.error("系统错误", e);
        return new FastResponse().message(e.getMessage());
    }
    ...
    public FastResponse handleConstraintViolationException(ConstraintViolationException e) {
        ...
        return new FastResponse().message(message.toString());
    }
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public FastResponse handleBindException(BindException e) {
        StringBuilder message = new StringBuilder();
