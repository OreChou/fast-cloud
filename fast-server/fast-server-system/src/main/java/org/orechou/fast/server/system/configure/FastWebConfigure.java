...
import org.orechou.fast.server.system.properties.FastSwaggerProperties;
...
public class FastWebConfigure {
    ...
    public Docket swaggerApi() {
        FastSwaggerProperties swagger = properties.getSwagger();
    ...
    private ApiInfo apiInfo(FastSwaggerProperties swagger) {
        return new ApiInfo(
                swagger.getTitle(),
    ...
    private SecurityScheme securityScheme(FastSwaggerProperties swagger) {
    ...
    private SecurityContext securityContext(FastSwaggerProperties swagger) {
    ...
    private AuthorizationScope[] scopes(FastSwaggerProperties swagger) {
